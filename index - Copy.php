...
<div id="cover">
  <div class="cover-bg">
    <img src="foto/sarah-2.jpeg" alt="bg">
  </div>
...
<div class="bg-animated-nature">
  <!-- <img src="foto/sarah-5.jpeg" class="animate-leaf" style="top:0; left:50%; width:170%;"> -->
...
<div id="page">
    ...
    <div class="card fade timeline-card">
      ...
      <div class="timeline">
        ...
        <div class="timeline-item left">
          ...
          <div class="timeline-content">
            <h4>10.30 — Sesi Foto Keluarga</h4>
        ...
        <div class="timeline-item right">
          <div class="timeline-dot"><img src="https://indoinvite.com/nikah/template/elegan-nature/tulip.webp" class="timeline-orn"></div>
          <div class="timeline-content">
            <h4>11.00 — Resepsi Dibuka</h4>
            <p>Resepsi resmi dibuka, tamu dapat menikmati hidangan.</p>
          </div>
        </div>
        <div class="timeline-item left">
          <div class="timeline-dot"><img src="index_files/orchied.webp" class="timeline-orn"></div>
          <div class="timeline-content">
            <h4>12.00 — Ramah Tamah</h4>
            <p>Saling sapa antar tamu undangan dan mempelai.</p>
          </div>
        </div>
        <div class="timeline-item right">
          <div class="timeline-dot"><img src="/index_files/leaf.webp" class="timeline-orn"></div>
          <div class="timeline-content">
            <h4>14.00 — Acara Selesai</h4>
  ...
  <section id="gallery">
    <div class="card fade">
      ...
      <div class="gallery" id="galleryInner">
        <img src="/foto/sarah-1.jpeg" alt="g1">
        <img src="/foto/sarah-2.jpeg" alt="g2">
        <img src="/foto/sarah-3.jpeg" alt="g3">
        <img src="/foto/sarah-4.jpeg" alt="g4">
        <img src="/foto/sarah-5.jpeg" alt="g5">
        <img src="/foto/sarah-6.jpeg" alt="g6">
      </div>
    </div>
  </section>
  ...
  <section id="hadiah">
    <div class="card fade">
      ...
      <p class="small-muted">Terima kasih atas doa dan dukungan Anda ❤️</p>
    </div>
  </section>
