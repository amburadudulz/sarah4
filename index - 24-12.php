...
<div id="page">
  ...
  <div class="cd-box">
    ...
    <small>Detik</small>
      ...
      <p class="akad-info">Minggu, 11 Januari 2026</p>
    </div>
  </section>
    ...
    <div class="card fade">
      ...
      <div class="mempelai-grid">
        <div class="mempelai-item">
          ...
          <p>Putra Ketiga dari<br/>Bapak Bambang Purwo Sutrisno <br/>& Ibu Heri Ningsih</p>
        </div>
        <div class="mempelai-item">
          <img src="foto/wanita.jpeg" alt="Mempelai Wanita">
          <h4>Maisaroh, S.E</h4>
          <p>Putri Kedua dari<br/>Bapak H. Jarliani <br/>& Ibu Hj. Syaripah</p>
        </div>
      </div>
    </div>
  </section>
